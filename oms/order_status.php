...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<?php
		...
		if(isset($_GET) && array_key_exists("OrderStatus",$_GET))
		{
			$FieldNames=array("Id", "OrderId", "CustomerId", "OrderDate", "Amount", "PaymentStatus", "OrderStatus", "ShipAddress", "PaymentType");
			$ParamArray=array();
			$ParamArray[0]=$_GET["OrderStatus"];
			$Fields=implode(",",$FieldNames);
			$single_data=$obj->MysqliSelect1("Select ".$Fields." from order_master where OrderStatus= ? ",$FieldNames,"s",$ParamArray);
			
			$OrderId=$single_data[0]["OrderId"];
			$OrderStatus=$single_data[0]["OrderStatus"];
		}
	  ?>
    <!-- Main content List-->
