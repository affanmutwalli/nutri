<?php
/**
 * Process All Pending Orders - Manual Trigger
 */
...
echo "<h1>🚀 Processing Pending Orders</h1>";
...
try {
    ...
    $query = "SELECT om.OrderId, om.CustomerId, om.CustomerType, om.Amount, om.ShipAddress,
                    ...
                    COALESCE(cm.MobileNo, dc.CustomerMobile, '') as CustomerPhone,
                    COALESCE(cm.Email, dc.CustomerEmail, '') as CustomerEmail
    ...
    echo "<li>Customers will receive WhatsApp notifications with tracking info</li>";
    echo "</ol>";
