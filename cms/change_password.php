            ...
            if ($result->num_rows === 1) {
                ...
                if ($user['password'] === $expected_current) {
                    ...
                    if ($update_stmt->execute()) {
                        ...
                        error_log("Password changed for user: " . $user_email);
                    } else {
                        $error_msg = 'Error updating password. Please try again.';
                        error_log("Password change failed for user: " . $user_email . " - " . $mysqli->error);
                    }
                } else {
                    $error_msg = 'Current password is incorrect.';
                    error_log("Failed password change attempt for user: " . $user_email . " - incorrect current password");
                }
            } else {
...
<head>
    ...
    <title>Change Password | MyNutrify CMS</title>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a href="dashboard.php" class="brand-link">
            <span class="brand-text font-weight-light">MyNutrify CMS</span>
        </a>
        <div class="sidebar">
